...
if __name__ == "__main__":
    ...
    # --- Exemplo de uso: Prever uma imagem ---
    # Substitua pelo caminho de uma imagem que você queira testar.
    # Exemplo: Crie uma pasta 'data/test_images/' na raiz do seu projeto (FIAP/)
    # e coloque uma imagem lá.
